...
$(document).ready(function () {
    ...
    function display_last_searched() {
        display_local_storage_side();
        var array_history = JSON.parse(window.localStorage.getItem("weather_history"));
    ...
    function display_local_storage_side() {
        var local_storage = JSON.parse(window.localStorage.getItem("weather_history"));
        ...
        for (var i = 0; i < local_storage.length; i++) {
            ...
            newElement.text(local_storage[i]);
